...
export function GratitudePost({ post }: { post: Post }) {
  ...
  return (
    <motion.article
      ...
      className="p-4 sm:p-5 md:p-6 rounded-2xl bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border border-white/20 dark:border-slate-700/50 shadow-xl hover:shadow-2xl hover:shadow-blue-500/20 dark:hover:shadow-blue-400/20 transition-all duration-300 mb-4"
    >
      <div className="flex items-start gap-2 sm:gap-3 mb-3 sm:mb-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 mb-2">
            <span className="font-semibold text-slate-800 dark:text-slate-100 text-sm sm:text-base drop-shadow-sm">
          ...
          <p className="text-sm sm:text-base text-slate-700 dark:text-slate-200 whitespace-pre-wrap break-words leading-relaxed drop-shadow-sm">
            {post.content}
          </p>
        </div>
      </div>
      <div className="flex items-center gap-3 sm:gap-4 pt-2 sm:pt-3 border-t border-slate-300/50 dark:border-slate-700/70">
        <motion.button
          onClick={handleReaction}
          disabled={isUpdating}
          className="flex items-center gap-1.5 sm:gap-2 text-slate-600 dark:text-slate-400 hover:text-grateful-primary dark:hover:text-grateful-accent transition-colors disabled:opacity-50 disabled:cursor-not-allowed touch-manipulation"
        ...
        <motion.button
          onClick={handleShare}
          className="flex items-center gap-1.5 sm:gap-2 text-slate-600 dark:text-slate-400 hover:text-blue-500 transition-colors touch-manipulation"
